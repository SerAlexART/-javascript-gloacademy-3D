...
// * Мы можем написать callback функцию, которая отработает ошибку после первой Callback функции, есди значение a_2 < 10
...
// Promise это "обещание", они возвращают результат какого-то асинхронного кода и мы получаем в ответ либо успех либо неудачу.
