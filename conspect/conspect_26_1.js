...
// Всё это подводка к следующей теме, а именно к методу Fetch(), который как раз из подкопота и работает на тех самых Promise, которые мы прошли, просто выглядят они гораздо проще.